// page/Company/Jobs/CreateJob.tsx
      ...
      <div className="lg:pl-[280px]">
        ...
        <div className="max-w-5xl mx-auto px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-600">Create a job posting to attract top talent</p>
          </div>
              ...
              {steps.map((step, index) => (
                <div key={step.number} className="flex items-center flex-1">
                  ...
                  {index < steps.length - 1 && (
                    <div className="flex-1 h-0.5 mx-4 bg-gray-200 relative" style={{ marginTop: "-30px" }}>
                      <motion.div
                        initial={{ width: "0%" }}
              ...
              {currentStep === 1 && (
                ...
                >
                  ...
                  <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <p className="text-sm font-semibold text-blue-900 mb-2">💡 Tips for a great job title</p>
                    <p className="text-xs text-blue-800">
                      Use clear, specific titles that candidates search for. Include seniority level and main technology/focus area.
                    </p>
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      className="w-32 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-sm"
                    />
                  </div>
                </motion.div>
              )}
              ...
              {currentStep === 2 && (
                ...
                >
                  ...
                  <div className="mb-6">
                    ...
                    />
                    <div className="flex items-center justify-between mt-1">
                      <span className={`text-xs ${formData.description.length >= 100 ? "text-green-600" : "text-amber-600"}`}>
                  ...
                  <div className="mb-6">
                    ...
                    <button
                      ...
                      className="mt-3 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-semibold text-sm flex items-center gap-2"
                    >
              ...
              {currentStep === 3 && (
                ...
                >
                  ...
                  <div className="p-6 bg-gray-50 border border-gray-200 rounded-xl">
                    <h3 className="text-sm font-bold text-gray-900 mb-4">Job Preview</h3>
                    <div className="space-y-2 text-sm">
                      ...
                      <p>
                        ...
                        <span className="font-semibold text-gray-900">{formData.jobType || "Not set"}</span>
                      </p>
                      <p>
                        <span className="text-gray-600">Location:</span>{" "}
                        <span className="font-semibold text-gray-900">{formData.workMode || "Not set"}</span>
                      </p>
