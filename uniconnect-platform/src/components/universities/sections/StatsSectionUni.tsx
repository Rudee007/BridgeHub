      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
          ...
          <StatItem
            value={100}
            suffix="k+"
            label="Successful Graduates Placed"
            delay={0.6}
          />
        </div>
        ...
        >
          <p className="text-gray-400 text-sm mb-6">Supporting academic excellence worldwide</p>
          <div className="flex flex-wrap items-center justify-center gap-8 opacity-50">
            {/* Add your tech logos here */}
            <div className="text-gray-500 text-xs font-mono">NIT Rourkela</div>
            <div className="text-gray-500 text-xs font-mono">MIT</div>
            <div className="text-gray-500 text-xs font-mono">IIT Ropar</div>
            <div className="text-gray-500 text-xs font-mono">OXFORD</div>
            <div className="text-gray-500 text-xs font-mono">GIET</div>
          </div>
        </motion.div>
      </div>
    </section>
